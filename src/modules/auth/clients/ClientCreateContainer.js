							...
							<CardBody>
								...
								{metaData["properties"] && Object.entries(metaData["properties"]).map(([key, value]) => {
									switch(key) {
										...
										case 'client_name': return(<TextInput key={key} name={key} register={register} title={t("ClientCreateContainer|Required")} labelName={t('ClientCreateContainer|Client name')}/>)
